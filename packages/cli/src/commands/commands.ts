...
declare const VRAX_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof VRAX_CLI_NAME === "string" ? VRAX_CLI_NAME : "vrax", {
  description: "Vrax security research framework",
  commands: [
    Spec.make("debug", {
