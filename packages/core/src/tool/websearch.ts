...
import { ToolFailure } from "@vrax/llm"
...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.VRAX_WEBSEARCH_PROVIDER === "exa" || process.env.VRAX_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.VRAX_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("VRAX_EXPERIMENTAL") || truthy("VRAX_ENABLE_EXA") || truthy("VRAX_EXPERIMENTAL_EXA"),
    enableParallel: truthy("VRAX_ENABLE_PARALLEL") || truthy("VRAX_EXPERIMENTAL_PARALLEL"),
