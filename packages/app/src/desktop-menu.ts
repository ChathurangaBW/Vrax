...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "Vrax Documentation", href: "https://vrax.dev/docs" },
      { type: "item", label: "Support Forum", href: "https://vrax.dev/community" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/vrax-dev/vrax/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/vrax-dev/vrax/issues/new?template=bug_report.yml",
      },
    ],
  },
]
