import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@vrax/sdk/v2/client"
...
import { List, type ListRef } from "@vrax/ui/list"
          ...
          <Match when={provider().id === "opencode"}>
            <div class="flex flex-col gap-4">
              ...
              <div class="text-14-regular text-text-base">
                ...
                <Link href="https://vrax.dev/zen" tabIndex={-1}>
