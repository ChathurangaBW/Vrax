...
beforeAll(async () => {
  ...
  mock.module("@vrax/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@vrax/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@vrax/ui/icon", () => ({ Icon: () => null }))
  mock.module("@vrax/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
