...
import { base64Encode } from "@vrax/core/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@vrax/ui/resize-handle"
import { Button } from "@vrax/ui/button"
import { IconButton } from "@vrax/ui/icon-button"
import { Tooltip } from "@vrax/ui/tooltip"
import { DropdownMenu } from "@vrax/ui/dropdown-menu"
import { Dialog } from "@vrax/ui/dialog"
import { getFilename } from "@vrax/core/util/path"
import { Session, type Message } from "@vrax/sdk/v2/client"
...
import { toaster } from "@vrax/ui/toast"
...
import { retry } from "@vrax/core/util/retry"
...
import { useTheme, type ColorScheme } from "@vrax/ui/theme/context"
...
import { VraxShell } from "@/vrax/shell/VraxShell"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://vrax.dev/desktop-feedback")}
      renderPanel={() =>
  ...
  return (
    <VraxShell>
      <Show when={!autoselecting.loading}>{props.children}</Show>
    </VraxShell>
  )
}
