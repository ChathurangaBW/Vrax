...
import { Logo } from "@vrax/ui/logo"
import { Spinner } from "@vrax/ui/spinner"
import { ScrollView } from "@vrax/ui/scroll-view"
import { ProjectAvatar } from "@vrax/ui/v2/project-avatar-v2"
import { ButtonV2 } from "@vrax/ui/v2/button-v2"
import { Icon as IconV2 } from "@vrax/ui/v2/icon"
import { IconButtonV2 } from "@vrax/ui/v2/icon-button-v2"
import { MenuV2 } from "@vrax/ui/v2/menu-v2"
    ...
    <div class="rounded-[10px] shadow-[var(--v2-elevation-raised)] m-2 min-h-0 lg:overflow-hidden bg-v2-background-bg-base self-stretch flex-1">
      <div class="mx-auto grid w-full h-full max-w-[1080px] gap-8 px-6 pb-16 lg:grid-cols-[280px_minmax(0,720px)]">
        <HomeProjectColumn
          ...
          openHelp={() => platform.openLink("https://vrax.dev/desktop-feedback")}
          language={language}
        />
