export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Vrax",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Vrax.",
  ...
  "provider.connect.opencodeZen.line1":
    "Vrax Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programaciÃ³n.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu cÃ³digo de autorizaciÃ³n para conectar tu cuenta y usar modelos de {{provider}} en Vrax.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el cÃ³digo a continuaciÃ³n para conectar tu cuenta y usar modelos de {{provider}} en Vrax.",
  ...
  "dialog.plugins.empty": "Plugins configurados en vrax.json",
  ...
  "dialog.server.description": "Cambiar a quÃ© servidor de Vrax se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versiÃ³n de Vrax ({{version}}) estÃ¡ disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Vrax",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuraciÃ³n (vrax.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" fallÃ³. Nota, Vrax no soporta autenticaciÃ³n MCP todavÃ­a.',
  ...
  "sidebar.gettingStarted.line1": "Vrax incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Vrax dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualizaciÃ³n para Vrax",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cÃ³mo se ve Vrax en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Vrax sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Vrax.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automÃ¡ticamente cuando se inicia Vrax",
  ...
  "settings.updates.toast.latest.description": "EstÃ¡s usando la Ãºltima versiÃ³n de Vrax.",
