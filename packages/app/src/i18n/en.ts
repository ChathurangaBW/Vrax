export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Vrax",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Vrax.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Vrax Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Vrax.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Vrax.",
  ...
  "dialog.plugins.empty": "Plugins configured in vrax.json",
  ...
  "dialog.server.description": "Switch which Vrax server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Vrax",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Vrax...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Vrax in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Vrax...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Vrax in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Vrax in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Vrax",
  "wsl.onboarding.opencodeReadyIn": "Vrax is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Vrax is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Vrax in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Vrax",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Vrax.",
  ...
  "toast.update.description": "A new version of Vrax ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Vrax team",
  ...
  "error.chain.checkConfig": "Check your config (vrax.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Vrax does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Vrax includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Vrax server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Vrax",
  ...
  "settings.general.row.appearance.description": "Customise how Vrax looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Vrax follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Vrax is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Vrax launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Vrax.",
