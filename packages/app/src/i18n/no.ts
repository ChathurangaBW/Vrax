...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Vrax",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nÃ¸kkel for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i Vrax.",
  ...
  "provider.connect.opencodeZen.line1":
    "Vrax Zen gir deg tilgang til et utvalg av pÃ¥litelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for Ã¥ hente autorisasjonskoden din for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i Vrax.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i Vrax.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i vrax.json",
  ...
  "dialog.server.description": "Bytt hvilken Vrax-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Vrax ({{version}}) er nÃ¥ tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Vrax-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandÃ¸r-/modellnavnene i konfigurasjonen din (vrax.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Vrax ikke stÃ¸tter MCP-autentisering ennÃ¥.',
  ...
  "sidebar.gettingStarted.line1": "Vrax inkluderer gratis modeller sÃ¥ du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "KjÃ¸r Vrax-serveren i WSL pÃ¥ Windows.",
  ...
  "settings.general.row.language.description": "Endre visningssprÃ¥ket for Vrax",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Vrax ser ut pÃ¥ enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Vrax skal fÃ¸lge systemets, lyst eller mÃ¸rkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Vrax er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer nÃ¥r Vrax starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Vrax.",
