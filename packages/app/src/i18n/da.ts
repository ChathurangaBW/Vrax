export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Vrax",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nÃ¸gle for at forbinde din konto og bruge {{provider}} modeller i Vrax.",
  ...
  "provider.connect.opencodeZen.line1":
    "Vrax Zen giver dig adgang til et udvalg af pÃ¥lidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Vrax.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Vrax.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i vrax.json",
  ...
  "dialog.server.description": "Skift hvilken Vrax-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Vrax ({{version}}) er nu tilgÃ¦ngelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Vrax-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (vrax.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. BemÃ¦rk, Vrax understÃ¸tter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Vrax inkluderer gratis modeller sÃ¥ du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "KÃ¸r Vrax-serveren inde i WSL pÃ¥ Windows.",
  ...
  "settings.general.row.language.description": "Ã†ndr visningssproget for Vrax",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Vrax ser ud pÃ¥ din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "VÃ¦lg om Vrax fÃ¸lger systemets, lyst eller mÃ¸rkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Vrax er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, nÃ¥r Vrax starter",
  ...
  "settings.updates.toast.latest.description": "Du kÃ¸rer den nyeste version af Vrax.",
