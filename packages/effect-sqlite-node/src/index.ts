...
export const TypeId: TypeId = "~@vrax/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@vrax/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@vrax/effect-sqlite-node/NodeSqliteClient")
