...
import defaultSoundPath from "@vrax/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@vrax/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@vrax/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@vrax/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@vrax/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@vrax/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "vrax"
const DEFAULT_PACK_ID = "vrax.default"
