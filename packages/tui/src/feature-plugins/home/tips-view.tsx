import type { TuiPluginApi } from "@vrax/plugin/tui"
...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at vrax.dev",
  ...
  "Create a plugin to prevent Vrax from reading sensitive files",
  "Use {highlight}opencode run{/highlight} for non-interactive scripting",
  "Use {highlight}opencode --continue{/highlight} to resume the last session",
  "Use {highlight}opencode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}vrax serve{/highlight} for headless API access to Vrax",
  ...
  "Use {highlight}/connect{/highlight} with Vrax Zen for curated, tested models",
