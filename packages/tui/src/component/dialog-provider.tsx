...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@vrax/sdk/v2"
      ...
      description={
        {
          opencode: (
            <box gap={1}>
              <text fg={theme.textMuted}>
                Vrax Zen gives you access to all the best coding models at the cheapest prices with a single API
                key.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://vrax.dev/zen</span> to get a key
              </text>
            </box>
          ),
          "opencode-go": (
            <box gap={1}>
              <text fg={theme.textMuted}>
                Vrax Go is a $10 per month subscription that provides reliable access to popular open coding models
                with generous usage limits.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://vrax.dev/go</span> and enable Vrax Go
              </text>
            </box>
          ),
