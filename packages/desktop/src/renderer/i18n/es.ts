export const dict = {
  ...
  "desktop.updater.none.message": "Ya estÃ¡s usando la versiÃ³n mÃ¡s reciente de Vrax",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versiÃ³n {{version}} de Vrax. Â¿Quieres instalarla y reiniciar?",
