...
const releaseId = process.env.VRAX_RELEASE
if (!releaseId) throw new Error("VRAX_RELEASE is required")

const version = process.env.VRAX_VERSION
if (!version) throw new Error("VRAX_VERSION is required")
