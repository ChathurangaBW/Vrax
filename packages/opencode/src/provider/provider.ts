...
import { Hash } from "@vrax/core/util/hash"
...
import { optionalOmitUndefined } from "@vrax/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@vrax/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
