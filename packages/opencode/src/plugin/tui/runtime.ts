...
import {
  ...
  type TuiSlotPlugin,
  type TuiTheme,
} from "@vrax/plugin/tui"
import path from "path"
import { fileURLToPath } from "url"
import { TuiConfig } from "@/config/tui"
import { errorData, errorMessage } from "@vrax/tui/util/error"
...
import { hasTheme, upsertTheme } from "@vrax/tui/context/theme"
import { Global } from "@vrax/core/global"
import { Filesystem } from "@/util/filesystem"
import { Process } from "@/util/process"
import { Flock } from "@vrax/core/util/flock"
import { Flag } from "@vrax/core/flag/flag"
import { internalTuiPlugins, type InternalTuiPlugin } from "./internal"
import type { HostPluginApi, HostSlots } from "@vrax/tui/plugin/slots"
import { ConfigPlugin } from "@/config/plugin"
import { ConfigPluginV1 } from "@vrax/core/v1/config/plugin"
import { createCommandShim } from "@vrax/tui/plugin/command-shim"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Effect } from "effect"
import { createPluginRuntime, type PluginRuntime, type TuiPluginHost } from "@vrax/tui/plugin/runtime"
...
async function load(input: {
  ...
  try {
    ...
    const records = Flag.VRAX_PURE ? [] : pluginOrigins
    if (Flag.VRAX_PURE && pluginOrigins.length) {
    }
