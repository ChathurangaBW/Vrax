...
import { ProjectDirectoryTable, ProjectTable } from "@vrax/core/project/sql"
...
import { which } from "@vrax/core/util/which"
...
import { AppProcess } from "@vrax/core/process"
import { ProjectV2 } from "@vrax/core/project"
import { ProjectCopy } from "@vrax/core/project/copy"
import { CrossSpawnSpawner } from "@vrax/core/cross-spawn-spawner"
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@vrax/core/schema"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.VRAX_FAKE_VCS)
