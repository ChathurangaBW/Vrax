...
import { EventSequenceTable, EventTable } from "@vrax/core/event/sql"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        VRAX_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        VRAX_WORKSPACE_ID: config.id,
        VRAX_EXPERIMENTAL_WORKSPACES: "true",
