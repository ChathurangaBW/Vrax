import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@vrax/llm"
...
// Move this extraction into @vrax/llm when Copilot is handled by the native runtime.
