import type { JsonSchema, LLMRequest, ProviderMetadata } from "@vrax/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@vrax/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @vrax/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
