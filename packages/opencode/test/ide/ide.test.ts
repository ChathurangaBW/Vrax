...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders VRAX_CALLER", () => {
    process.env["VRAX_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode VRAX_CALLER", () => {
    process.env["VRAX_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown VRAX_CALLER", () => {
    process.env["VRAX_CALLER"] = "unknown"
