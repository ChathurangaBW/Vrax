  ...
  Effect.gen(function* () {
    ...
    yield* Effect.addFinalizer(() =>
      Effect.sync(() => {
        ...
        restoreEnv("VRAX_SERVER_PASSWORD", original.envPassword)
        restoreEnv("VRAX_SERVER_USERNAME", original.envUsername)
      }),
    )
  }),
)
      ...
      Layer.provide(
        ConfigProvider.layer(
          ConfigProvider.fromUnknown({
            VRAX_SERVER_PASSWORD: input?.password,
            VRAX_SERVER_USERNAME: input?.username,
          }),
        ),
      ),
    ),
