...
//   - VRAX_CONFIG_CONTENT      : provider config inline, no files to find
//   - VRAX_TEST_HOME           : pins os.homedir() → tmpdir
//   - VRAX_DISABLE_PROJECT_CONFIG : skip walking up for opencode.json
//   - VRAX_PURE                : skip external plugin discovery + install
//   - VRAX_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
...
function isolatedEnv(home: string, configJson: string): Record<string, string> {
  return {
    ...
    VRAX_CONFIG_CONTENT: configJson,
    VRAX_DISABLE_PROJECT_CONFIG: "1",
    VRAX_PURE: "1",
    VRAX_DISABLE_AUTOUPDATE: "1",
    VRAX_DISABLE_AUTOCOMPACT: "1",
    VRAX_DISABLE_MODELS_FETCH: "1",
    VRAX_AUTH_CONTENT: "{}",
  }
}
