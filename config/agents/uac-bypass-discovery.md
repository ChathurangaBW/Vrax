...
```
C:\Users\Sniffer\.opencode\agents\uac_coverage_taxonomy.json   (attack_surfaces list)
C:\Users\Sniffer\.opencode\agents\uac_external_intel.json       (source pointers)
C:\Users\Sniffer\.opencode\agents\uac-bypass-playbook           (methodology + surface→binary map)
...
| Health script | `powershell -File C:\Users\Sniffer\.opencode\agents\ida_mcp_health.ps1` |
...
1. `py -3.14 C:\Users\Sniffer\.opencode\agents\uac_poc_validate.py --workspace D:\Cracked\uac-lab` → exit 0
2. `py -3.14 C:\Users\Sniffer\.opencode\agents\uac_validate.py --workspace D:\Cracked\uac-lab --mode catalog`
